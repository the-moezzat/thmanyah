...
const AnimatedSphere: React.FC<AnimatedSphereProps> = ({
  ...
  const defaultColors = {
    bg: 'oklch(95% 0.02 150)', // Light background for fresh feel
    c1: 'oklch(85% 0.15 100)', // Vibrant yellow
    c2: 'oklch(70% 0.18 160)', // Lush green
    c3: 'oklch(75% 0.10 200)', // Complementary light blue/teal
  };
